...
export const EditWorkspaceForm = ({ onCancel, initialValues }: EditWorkspaceProps) => {
    ...
    return (
        <div className="flex flex-col gap-y-4">
            <DeleteDialog />
            <ResetDialog />
            <Card className="w-full h-full border-nono shadow-none">
                                            ...
                                            <div className="flex flex-col gap-y-2">
                                                <div className="flex items-center gap-x-5">
                                                    {field.value ? (
                                                        ...
                                                        /> */}
                                                            <Avatar className="size-[72px] relative rounded-md overflow-hidden">
            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Use the invite link to add a members to your workspace
                        </p>
                        <div className="mt-4">
