...
const app = new Hono()
    ...
    .post(
        ...
        async (c) => {
            ...
            if (workspace.inviteCode !== code) {
                return c.json({ error: "Invalidate invite code" }, 400);
            }
    ...
    .get(
        ...
        async (c) => {
            ...
            const incompleteTaskCountDifference =
            ...
            const completedTaskCountDifference =
